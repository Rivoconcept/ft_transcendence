...
DB_HOST=$(jq -r .DB_HOST /vault/vault-init.json)
DB_PORT=$(jq -r .DB_PORT /vault/vault-init.json)
POSTGRES_DB=$(jq -r .POSTGRES_DB /vault/vault-init.json)
POSTGRES_USER=$(jq -r .POSTGRES_USER /vault/vault-init.json)
POSTGRES_PASSWORD=$(jq -r .POSTGRES_PASSWORD /vault/vault-init.json)
PGADMIN_SERVER_NAME=$(jq -r .PGADMIN_SERVER_NAME /vault/vault-init.json)
PGADMIN_DEFAULT_EMAIL=$(jq -r .PGADMIN_DEFAULT_EMAIL /vault/vault-init.json)
PGADMIN_DEFAULT_PASSWORD=$(jq -r .PGADMIN_DEFAULT_PASSWORD /vault/vault-init.json)
SMTP_HOST=$(jq -r .SMTP_HOST /vault/vault-init.json)
SMTP_PORT=$(jq -r .SMTP_PORT /vault/vault-init.json)
SMTP_USER=$(jq -r .SMTP_USER /vault/vault-init.json)
SMTP_PASS=$(jq -r .SMTP_PASS /vault/vault-init.json)
SMTP_FROM=$(jq -r .SMTP_FROM /vault/vault-init.json)
